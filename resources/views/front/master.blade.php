...
<head>
  ...
  <link type="text/css" href="{{ asset ('css/font-awesome.css')}}" rel="stylesheet" />
          ...
          <ul>
						<li><a href="{{url('/products')}}">Products</a>
							<ul class="dropdown">
								 ...
								 <li>
									 <a href="{{url('products')}}/{{$item->cat_name}}"><b>{{$item->cat_name}}</b></a>
...
CART({{Cart::count()}})
      ...
      <div>
        <ul class="topnav">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="#">Suspendisse semper</a>
              </li>
              <li>
                <a href="#">lorem gravida</a>
              </li>
              <li>
                <a href="#">Vestibulum</a>
              </li>
        ...
        <div class="mob-nav">
          <ul>
            <li>
              <a href="business-enquiry.php">
                <i class="fa fa-th"></i> Bulk Buying</a>
            </li>
            <li>
              <a href="faq.php">
                <i class="fa fa-question-circle"></i> Faq's</a>
            </li>
            <li>
              <a href="testimonials.php">
                <i class="fa fa-users"></i> Testimonials</a>
            </li>
            <li>
              <a href="shipping-policy.php">
                <i class="fa fa-paper-plane"></i> Shipping Policy</a>
            </li>
            <li>
              <a href="return-policy.php">
                <i class="fa fa-refresh"></i> Return Policy</a>
            </li>
  ...
  <footer id="footer">
    <div class="container">
        ...
        <div class="col-sm-12">
          <div class="col-sm-3 col-lg-3 hidden-xs">
            ...
            <div class="ft-link">
              <ul>
                <li>
                  <a href="business-enquiry.php">Bulk Buying</a>
                </li>
                <li>
          ...
          <div class="col-sm-3 col-lg-3 hidden-xs">
            ...
            <div class="ft-link">
              <ul>
                <li>
                  <a href="ayurvedic-doshas.php">Ayurvedic Doshas</a>
                </li>
                <li>
                  <a href="gluten-allergy.php">Gluten Allergy</a>
                </li>
                <li>
                  <a href="ayurvedic-diet.php">Ayurvedic Diet</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyrt">
            &copy; 2018 LaraShop. All Rights Reserved.
  ...
  <script type="text/javascript" src="{{ asset ('js/multiple-accordion.js')}}"></script>
  <script type="text/javascript" src="{{ asset ('js/jquery.nice-select.js')}}"></script>
  <script type="text/javascript" src="{{ asset ('js/jquery.bootstrap-responsive-tabs.js')}}"></script>
  <script>
    $(function () {
      var html = $('html, body'),
